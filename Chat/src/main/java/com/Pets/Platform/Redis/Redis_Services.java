package com.Pets.Platform.Redis;
...
public class Redis_Services {
	...
	@Autowired
	@Qualifier("Save_ChatMember") // 참여자 저장용
	private RedisTemplate<String, Object> ChatMember;
	...
	public void Insert_ChatMember(ChatRoom room , List<String> id_list) {//채팅 참여 맴버 리스트 저장
	    try {
	    	ChatMember.opsForSet().add(room.getUuid(), id_list.toArray());
	    } catch (Exception e) {
